...
function playAnimation(fbxName) {
    ...
    function init() {
        ...
        camera = new THREE.PerspectiveCamera(45, 250 / 487, 3, 200000);     //케릭터 생성위치(width/height)
        camera.position.set(100, 3000, 5500);
        ...
        renderer.setSize(250, 487);     //챗팅창에 고려한 canvas 사이즈 임의 조정

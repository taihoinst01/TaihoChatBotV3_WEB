...
function playAnimation(fbxName) {
    ...
    function init() {
        ...
        camera = new THREE.PerspectiveCamera(45, 338 / 588, 1, 200000);     //케릭터 생성위치(width/height)
        camera.position.set(100, 10000, 15000);
        ...
        renderer.setSize(338, 588);     //챗팅창에 고려한 canvas 사이즈 임의 조정
